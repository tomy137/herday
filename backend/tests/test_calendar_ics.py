...
def test_ics_structure_and_crlf():
    blocks = compute_blocks(_confident_cycles(), [], TODAY)
    ics = render_ics(_user(), blocks, "https://herday.test", NOW, TODAY)
...
def test_discreet_labels_hide_content():
    blocks = compute_blocks(_confident_cycles(), [], TODAY)
    ics = render_ics(_user(mode="discreet"), blocks, "https://herday.test", NOW, TODAY)
...
def test_explicit_labels_and_alarm():
    blocks = compute_blocks(_confident_cycles(), [], TODAY)
    ics = render_ics(_user(mode="explicit"), blocks, "https://herday.test", NOW, TODAY)
